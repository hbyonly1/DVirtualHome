...
extern "C" void
AudioServicesPlaySystemSoundWithVibration(SystemSoundID inSystemSoundID,
                                          id unknown, NSDictionary *options);
...
#define kSettingsPath                                                          \
  @"/var/mobile/Library/Preferences/com.dgh0st.dvirtualhome.plist"
#define kSettingsChangedNotification                                           \
  (CFStringRef) @"com.dgh0st.dvirtualhome/settingschanged"
...
static CGFloat vibrationInterval = 0.20;
static BOOL isIPhone7GestureFeedbackEnabled = NO;
static CGFloat customDoubleTapInterval = 0.07;
...
- (BOOL)toggleMainSwitcherNoninteractivelyWithSource:(NSInteger)arg1
                                            animated:(BOOL)arg2;
@end
...
@interface SiriPresentationSpringBoardMainScreenViewController
    : UIViewController
- (oneway void)presentationRequestedWithPresentationOptions:(id)arg1
                                             requestOptions:(id)arg2;
@end
...
+ (BOOL)isVisible;
+ (id)sharedInstance;
- (BOOL)handleSiriButtonDownEventFromSource:(NSInteger)arg1
                            activationEvent:(NSInteger)arg2;
...
- (void)_presentCoverSheetAnimated:(BOOL)arg1
                    forUserGesture:(BOOL)arg2
...
@property(retain, nonatomic)
    UIHBClickGestureRecognizer *singleTapGestureRecognizer;
@property(retain, nonatomic)
    UILongPressGestureRecognizer *longTapGestureRecognizer;
@property(retain, nonatomic)
    UILongPressGestureRecognizer *tapAndHoldTapGestureRecognizer;
@property(retain, nonatomic)
    UILongPressGestureRecognizer *vibrationGestureRecognizer;
@property(retain, nonatomic)
...
@property(nonatomic, readonly)
    SBApplicationProcessState *processState; // iOS 11+
